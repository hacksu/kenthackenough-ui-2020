<template>
  <div id="landing-container">
    ...
    <div class="img-box headphones-orange" style="background-position-y: 5vh; background-position-x: 10vh; right: 0px; top: 0px;"></div>
    ...
    <div id="landing-content-container">
      <p class="woah">OCTOBER 2020</p>
      <p class="woah">Kent State Library</p>
...
#landing-content-container {
  ...
  p {
    ...
    color: white;
    filter: drop-shadow(4px 4px #92D4E7) drop-shadow(-1.5px -1.5px #92D4E7);
    /*font-size: 8vh;*/
